...
if (!$A_ID) {
    ...
    $sql2 = mysqli_query($con, "select * from locations where id='$location_id'");
    ...
    if (isset($_POST['Submit'])) {
        ...
        $stmt = $con->prepare("UPDATE locations SET name = ? WHERE id = ? ");
          ...
          <div class="col-lg-12">
            <div class="card">
              <div class="card-body">
                ...
                <!-- Horizontal Form -->
                <form method="POST" action="./Edit-Location.php?location_id=<?php echo $location_id ?>" enctype="multipart/form-data">
                ...
                <input type="hidden" name="location_id" value="<?php echo $location_id ?>">
                  ...
                  <div class="row mb-3">
                    ...
                    >
                    <div class="col-sm-10">
                      <input type="text" name="name" value="<?php echo $locationName ?>" class="form-control" id="inputText" />
                    </div>
                  </div>
